import 'package:CampoyTT/PDM_Screen.dart';
import 'package:CampoyTT/PRUEBA.dart';


import 'package:CampoyTT/comunicacion/foro.dart';
...
class Home_otros extends StatelessWidget {
  
  const Home_otros({Key? key}) : super(key: key);
