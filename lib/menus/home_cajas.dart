import 'package:CampoyTT/menus/home_page.dart';
import 'package:CampoyTT/master/masterscreen.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';


class Home_cajas extends StatelessWidget {
  const Home_cajas({Key? key}) : super(key: key);
        ...
        child: GridView.count(
          ...
          children: [
            _buildContainer(
              ...
              context,
              ' MASTER ',
              'Ve la variedad de productos (granel/unid)',
              Icons.apple,
              MasterScreen(),
