...
class FruteriaScreen extends StatefulWidget {
  @override
  _FruteriaScreenState createState() => _FruteriaScreenState();
}

class _FruteriaScreenState extends State<FruteriaScreen> {
  ...
  void fetchDocuments() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .where('tipo', isEqualTo: 'Frutas y Verduras')
        .get();
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Text(
              'Conoce la variedad de frutas y verduras que tenemos actualmente',
