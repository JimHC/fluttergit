...
class ComidaRapidaScreen extends StatefulWidget {
  @override
  _ComidaRapidaScreenState createState() => _ComidaRapidaScreenState();
}

class _ComidaRapidaScreenState extends State<ComidaRapidaScreen> {
  ...
  void fetchDocuments() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .where('tipo', isEqualTo: 'Comida Rapida')
        .get();
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Text(
              'Conoce la variedad de comida rapida que tenemos actualmente',
