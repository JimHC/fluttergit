...
class PanaderiaScreen extends StatefulWidget {
  @override
  _PanaderiaScreenState createState() => _PanaderiaScreenState();
}

class _PanaderiaScreenState extends State<PanaderiaScreen> {
  ...
  void fetchDocuments() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .where('tipo', isEqualTo: 'Panaderia')
        .get();
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Text(
              'Conoce la variedad de panes que tenemos actualmente',
