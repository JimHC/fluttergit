...
class PPCScreen extends StatefulWidget {
  @override
  _PPCScreenState createState() => _PPCScreenState();
}

class _PPCScreenState extends State<PPCScreen> {
  ...
  void fetchDocuments() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .where('tipo', isEqualTo: 'Pollo, Pavo y Cerdo')
        .get();
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Text(
              'Conoce la variedad de productos referente a P.P.C que tenemos',
