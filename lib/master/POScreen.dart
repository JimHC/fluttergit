...
class _POScreenState extends State<POScreen> {
  ...
  void fetchDocuments() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .where('tipo', isEqualTo: 'Productos en Oferta')
        .get();
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                item['comentario'],
                style: TextStyle(
                  color: const Color.fromARGB(255, 203, 18, 18),
                ),
              ),
            ],
          ),
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Text(
              'Productos en oferta o en liquidacion, con el fin de que se venda antes que caduque',
